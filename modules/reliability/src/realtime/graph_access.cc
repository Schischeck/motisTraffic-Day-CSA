...
ev_key get_ev_key(schedule const& sched, edge const* re,
                  uint32_t const train_nr, std::vector<uint32_t> const& family,
                  std::string const& line_identifier,
                  motis::event_type const ev_type, time const sched_time) {
...
ev_key get_ev_key(schedule const& sched, uint32_t const train_nr,
                  std::vector<uint32_t> const& family,
                  std::string const& line_identifier,
                  station_node const* station, motis::event_type const ev_type,
