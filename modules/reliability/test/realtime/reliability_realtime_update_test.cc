...
TEST_F(reliability_realtime_update, is_message) {
                 ...
                 ris::EventType_Departure, ris::DelayType_Is));
  {
    ...
    ASSERT_DOUBLE_EQ(1.0, dist_dep_D.probability_equal(24));
  }
  auto const& n_L = *graph_accessor::get_departing_route_edge(n_D)->_to;
  {
    ...
    ASSERT_DOUBLE_EQ(0.1, dist_arr_L.probability_equal(23));
    ASSERT_DOUBLE_EQ(0.8, dist_arr_L.probability_equal(24));
    ASSERT_DOUBLE_EQ(0.1, dist_arr_L.probability_equal(25));
  }
  auto const& lc_L_F =
      graph_accessor::get_departing_route_edge(n_L)->_m._route_edge._conns[0];
  {
    ...
    ASSERT_DOUBLE_EQ(0.1, dist_dep_L.probability_equal(22));
    ASSERT_DOUBLE_EQ(0.8, dist_dep_L.probability_equal(23));
    ASSERT_DOUBLE_EQ(0.1, dist_dep_L.probability_equal(24));
  }
  {
    ...
    ASSERT_DOUBLE_EQ(0.16, dist_arr_F.probability_equal(22));
    ASSERT_DOUBLE_EQ(0.66, dist_arr_F.probability_equal(23));
    ASSERT_DOUBLE_EQ(0.16, dist_arr_F.probability_equal(24));
      ...
      graph_accessor::get_departing_route_edge(n_F)->_m._route_edge._conns[0];
  {
    ...
    ASSERT_DOUBLE_EQ(0.13599999999999987, dist_dep_F.probability_equal(0));
    ASSERT_DOUBLE_EQ(0.694, dist_dep_F.probability_equal(1));
    ASSERT_DOUBLE_EQ(0.16, dist_dep_F.probability_equal(2));
    ASSERT_DOUBLE_EQ(0.010000000000000009, dist_dep_F.probability_equal(3));
  }
  {
    ...
    ASSERT_DOUBLE_EQ(0.013599999999999987, dist_arr_H.probability_equal(-1));
    ASSERT_DOUBLE_EQ(0.17819999999999991, dist_arr_H.probability_equal(0));
    ASSERT_DOUBLE_EQ(0.58479999999999999, dist_arr_H.probability_equal(1));
    ASSERT_DOUBLE_EQ(0.19840000000000002, dist_arr_H.probability_equal(2));
    ASSERT_DOUBLE_EQ(0.024000000000000021, dist_arr_H.probability_equal(3));
    ASSERT_DOUBLE_EQ(0.0010000000000000009, dist_arr_H.probability_equal(4));
  }
}
}
}
