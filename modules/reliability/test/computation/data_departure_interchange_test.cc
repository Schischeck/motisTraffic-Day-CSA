  ...
  auto& tail_node_departing_train =
      *graph_accessor::get_departing_route_edge(
           *graph_accessor::get_first_route_node(sched(), schedule2::ICE_K_F_S))
           ->to_;
  ASSERT_TRUE(sched()
                  .stations_[tail_node_departing_train.station_node_->id_]
...
TEST_F(reliability_data_departure_interchange2,
  ...
  auto const& distribution_node = init_feeders_and_get_distribution_node(
      ...
      ic_data.departing_light_conn_, {0.9, 0.1}, 0, sched());
...
TEST_F(reliability_data_departure_interchange2,
  ...
  // departing train ICE_S_E from Stuttgart to Erlangen
  interchange_data_for_tests const ic_data(
      sched(), schedule2::S_H_S, schedule2::ICE_S_E, schedule2::HEILBRONN.eva_,
      schedule2::STUTTGART.eva_, schedule2::ERLANGEN.eva_, 7 * 60 + 15,
...
TEST_F(reliability_data_departure_interchange2,
  ...
  interchange_data_for_tests const ic_data(
      sched(), schedule2::ICE_S_E, schedule2::ICE_E_K,
...
TEST_F(reliability_data_departure_interchange3, interchange_walk) {
  ...
  interchange_data_for_tests const ic_data(
      sched(), schedule3::ICE_L_H, schedule3::S_M_W, schedule3::LANGEN.eva_,
