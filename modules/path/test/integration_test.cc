...
constexpr auto kPathIndexRequest = R""(
{
  "destination": {
    "type": "Module",
    "target": "/routes/index"
  },
  "content_type": "PathIndexRequest",
  "content": {
    "index": "0"
  }
}
...
constexpr auto kPathIdTrainRequest = R""(
{
  "destination": {
    "type": "Module",
...
constexpr auto kPathStationSeqRequest = R""(
{
  "destination": {
    "type": "Module",
    "target": "/routes/station_seq"
  },
  "content_type": "PathStationSeqRequest",
  "content": {
    "station_ids": [
      "0", "1"
    ],
...
TEST_F(routes_integration_test, prepare_index) {
  ...
  auto msg = call(make_msg(kPathIndexRequest));
  auto resp = motis_content(PathSeqResponse, msg);
...
TEST_F(routes_integration_test, prepare_station_seq) {
  ...
  auto msg = call(make_msg(kPathStationSeqRequest));
  auto resp = motis_content(PathSeqResponse, msg);
...
TEST_F(routes_integration_test, DISABLED_prepare_id_train) {
  ...
  auto msg = call(make_msg(kPathIdTrainRequest));
  auto resp = motis_content(PathSeqResponse, msg);
