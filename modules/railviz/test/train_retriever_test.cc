...
TEST(search_train, simple_test){
  ...
  auto train_retriever_ = new train_retriever(*schedule);
	geo::box area = {{49.8728, 8.24411},
                   {50.969, 9.79821}};
	std::vector<std::pair<light_connection const*, edge const*>> trains = train_retriever_->trains(2800, 3100, 1000, area);
