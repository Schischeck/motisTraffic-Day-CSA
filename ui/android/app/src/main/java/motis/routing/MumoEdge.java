...
public final class MumoEdge extends Table {
  ...
  public int mumoId() { int o = __offset(12); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  ...
  public static void startMumoEdge(FlatBufferBuilder builder) { builder.startObject(5); }
  ...
  public static void addMumoId(FlatBufferBuilder builder, int mumoId) { builder.addInt(4, mumoId, 0); }
