...
public final class Connection extends Table {
  ...
  public int nightPenalty() { int o = __offset(12); return o != 0 ? bb.getShort(o + bb_pos) & 0xFFFF : 0; }
  public int dbCosts() { int o = __offset(14); return o != 0 ? bb.getShort(o + bb_pos) & 0xFFFF : 0; }
  ...
  public static void addNightPenalty(FlatBufferBuilder builder, int nightPenalty) { builder.addShort(4, (short)nightPenalty, 0); }
  public static void addDbCosts(FlatBufferBuilder builder, int dbCosts) { builder.addShort(5, (short)dbCosts, 0); }
