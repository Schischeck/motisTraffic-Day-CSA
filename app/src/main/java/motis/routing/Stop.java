...
public final class Stop extends Table {
  ...
  public EventInfo arrival(EventInfo obj) { int o = __offset(12); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  public EventInfo departure() { return departure(new EventInfo()); }
  public EventInfo departure(EventInfo obj) { int o = __offset(14); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  public boolean interchange() { int o = __offset(16); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static int createStop(FlatBufferBuilder builder,
    ...
    Stop.addLng(builder, lng);
    Stop.addLat(builder, lat);
  ...
  public static void startStop(FlatBufferBuilder builder) { builder.startObject(7); }
  ...
  public static void addArrival(FlatBufferBuilder builder, int arrivalOffset) { builder.addOffset(4, arrivalOffset, 0); }
  public static void addDeparture(FlatBufferBuilder builder, int departureOffset) { builder.addOffset(5, departureOffset, 0); }
  public static void addInterchange(FlatBufferBuilder builder, boolean interchange) { builder.addBoolean(6, interchange, false); }
